...
const forms = () => {
  ...
  const clearInputs = () => {
    ...
    upload.forEach(item => {
      item.previousElementSibling.textContent = 'Файл не выбран'; //сбрасываем имя картинки
    })
  };
  ...
  form.forEach(item => {
    item.addEventListener('submit', (e) => {
      ...
      item.classList.add('animated', 'fadeOutUp');//скрываем первое модальное окно
      setTimeout(() => {
      ...
      statusMessage.appendChild(statusImg);           //
                                                      //показываем другое модальное окно(загрузка)
